...
class _UpdateProfileWidgetState extends State<UpdateProfileWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'update_profile'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('UPDATE_PROFILE_update_profile_ON_INIT_ST');
      logFirebaseEvent('update_profile_update_page_state');
                          ...
                          children: [
                            Padding(
                              ...
                              child: FlutterFlowIconButton(
                                ...
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'UPDATE_PROFILE_arrow_back_rounded_ICN_ON');
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      FlutterFlowIconButton(
                        ...
                        onPressed: () async {
                          logFirebaseEvent(
                              'UPDATE_PROFILE_cameraswitch_sharp_ICN_ON');
                          logFirebaseEvent(
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'UPDATE_PROFILE_SAVE_CHANGES_BTN_ON_TAP');
                        logFirebaseEvent('Button_backend_call');

                        await currentUserReference!
                            .update(createUsersRecordData(
                          displayName: _model.yourNameTextController3.text,
                          photoUrl: _model.photoURL,
                          firstName: _model.yourNameTextController1.text,
