                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'SETTINGS_PAGE_materialList_Item_2_ON_TAP');
                                logFirebaseEvent(
                                    'materialList_Item_2_launch_u_r_l');
                                await launchURL(
                                    'https://sites.google.com/uri.edu/squadup/about');
                              },
                              child: Container(
                                width: double.infinity,
                                decoration: BoxDecoration(),
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                ...
                                logFirebaseEvent(
                                    'materialList_Item_2_launch_u_r_l');
                                await launchURL(
                                    'https://sites.google.com/uri.edu/squadup/user-documentation');
                              },
                              child: Container(
                                width: double.infinity,
                                decoration: BoxDecoration(),
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                ...
                                logFirebaseEvent(
                                    'materialList_Item_2_launch_u_r_l');
                                await launchURL(
                                    'https://sites.google.com/uri.edu/squadup?usp=sharing');
                              },
                              child: Container(
                                width: double.infinity,
                                decoration: BoxDecoration(),
