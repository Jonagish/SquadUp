...
/// create a chat screen where it shows my message and other user's message.
///
/// my message on the right hand side and other user message on the left hand
/// side.
                          ...
                          child: Row(
                            ...
                            children: [
                              InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'CHAT_DETAIL_PAGE_Icon_xyfe8pue_ON_TAP');
                              ...
                              InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'CHAT_DETAIL_PAGE_Icon_7493ngrw_ON_TAP');
                                  logFirebaseEvent('Icon_navigate_to');

                                  context.pushNamed(
                                    ChatMoreWidget.routeName,
                                    queryParameters: {
                          ...
                          child: StreamBuilder<List<ChatsMessagesRecord>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              return ListView.separated(
                                ...
                                itemCount:
                                    listViewChatsMessagesRecordList.length,
                                        ...
                                        return Align(
                                          ...
                                          child: StreamBuilder<UsersRecord>(
                                            ...
                                            builder: (context, snapshot) {
                                              ...
                                              final otherUserMessagesUsersRecord =
                                                  snapshot.data!;
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'CHAT_DETAIL_Container_a447ftyr_ON_TAP');
                                        logFirebaseEvent(
                                            'Container_backend_call');

                                        await ChatsMessagesRecord.collection
                                            .doc()
                                        ...
                                        await widget.chatRef!.update({
                                          ...
                                          ...mapToFirestore(
                                            {
                                              'unread_users': columnChatsRecord
                                                  .users
                                                  .where((e) =>
