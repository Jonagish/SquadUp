...
import '/messagin/invite_users/invite_users_widget.dart';
import '/index.dart';
...
class ChatMoreWidget extends StatefulWidget {
  ...
  static String routeName = 'ChatMore';
  static String routePath = '/chatMore';
...
class _ChatMoreWidgetState extends State<ChatMoreWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'ChatMore'});
                      ...
                      child: Row(
                        ...
                        children: [
                          InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'CHAT_MORE_PAGE_Icon_ytovrdfd_ON_TAP');
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'CHAT_MORE_INVITE_MORE_USERS_BTN_ON_TAP');
                                ...
                                Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'CHAT_MORE_PAGE_LEAVE_CHAT_BTN_ON_TAP');
                                      ...
                                      context
                                          .pushNamed(ChatHomeWidget.routeName);
                                    },
                                    text: 'Leave Chat',
                                    options: FFButtonOptions(
                                      width: double.infinity,
